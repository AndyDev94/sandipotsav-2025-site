...
export function CulturalShowcase() {
  ...
  // Define image URL as a constant
  ...
  return (
    <div className="relative w-full min-h-[400px] overflow-hidden rounded-xl">
      ...
      {/* Content overlay */}
      <motion.div
        className="relative z-10 p-8 flex flex-col items-center justify-center min-h-[400px] text-center"
      ...
      {hasError && (
        <div className="absolute inset-0 bg-[#1E293B] flex flex-col items-center justify-center gap-4">
